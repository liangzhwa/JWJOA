...
function writeIframe()
{
    ...
    "    <table id=tableDay height=120 width=140 border=1 cellspacing=0 cellpadding=0>";
...
function WebCalendar() //初始化日历的设置
{
    ...
    this.darkColor  = "#3074D0";    //控件的暗色
    this.lightColor = "#FFFFFF";    //控件的亮色
    this.btnBgColor = "#DEDEDE";    //控件的按钮背景色
    this.wordColor  = "#000040";    //控件的文字颜色
    this.wordDark   = "#B2B2B2";    //控件的暗文字颜色
    this.dayBgColor = "#eff9fc";    //日期数字背景色
    this.todayColor = "#FDA852";    //今天在日历上的标示背景色

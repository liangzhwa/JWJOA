document.write("<div id='meizzCalendarLayer' style='position: absolute; z-index: 9999; width: 144px; height: 193px; display: none'><iframe id='meizzCalendarIframe' scrolling='no' frameborder='0' style='width:100%; height:100%'></iframe></div>");
function writeIframe()
{
    var strIframe = "<html><head><style type='text/css'>"+
    ...
    "</style></head><body onselectstart='return false;' style='margin: 0px' oncontextmenu='return false;'><form id='meizz'>";
...
function WebCalendar() //初始化日历的设置
{
    ...
    this.darkColor  = "#006699";    //控件的暗色
    this.lightColor = "#FFFFFF";    //控件的亮色
    this.btnBgColor = "#D5EDFF";    //控件的按钮背景色
    this.wordColor  = "#000040";    //控件的文字颜色
    this.wordDark   = "#A9A9A9";    //控件的暗文字颜色
    this.dayBgColor = "#E6F1FF";    //日期数字背景色
    this.todayColor = "#004AA1";    //今天在日历上的标示背景色
    this.DarkBorder = "#CBC4FF";    //日期显示的立体表达色
}
